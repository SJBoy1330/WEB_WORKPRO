            ...
            <div class="card-body flex-column p-5">
                ...
                <div class="d-flex align-items-center h-lg-300px p-5 p-lg-15">
                    ...
                    <div class="d-flex flex-column align-items-start justift-content-center flex-equal me-5">
                        <!--begin::Title-->
                        <h1 class="fw-bolder fs-4 fs-lg-1 text-gray-800 mb-5 mb-lg-10">Bagaimana Cara Kami Membantu Anda?</h1>
                        <!--end::Title-->
                        <!--begin::Input group-->
                    ...
                    <div class="row g-10">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-xl-stretch me-md-6">
                                ...
                                <div class="m-0">
                                    <!--begin::Title-->
                                    <a href="../../demo20/dist/pages/profile/overview.html" class="fs-4 text-dark fw-bolder text-hover-primary text-dark lh-base">Admin Panel - How To Started the Dashboard Tutorial</a>
                                    <!--end::Title-->
                                    <!--begin::Text-->
                                    ...
                                    <div class="fs-6 fw-bolder">
                                        <!--begin::Author-->
                                        <a href="../../demo20/dist/pages/profile/overview.html" class="text-gray-700 text-hover-primary">Jane Miller</a>
                                        <!--end::Author-->
                                        <!--begin::Date-->
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-xl-stretch mx-md-3">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="fs-6 fw-bolder">
                                        <!--begin::Author-->
                                        <a href="../../demo20/dist/pages/profile/overview.html" class="text-gray-700 text-hover-primary">Cris Morgan</a>
                                        <!--end::Author-->
                                        <!--begin::Date-->
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-xl-stretch ms-md-6">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="fs-6 fw-bolder">
                                        <!--begin::Author-->
                                        <a href="../../demo20/dist/pages/profile/overview.html" class="text-gray-700 text-hover-primary">Carles Nilson</a>
                                        <!--end::Author-->
                                        <!--begin::Date-->
