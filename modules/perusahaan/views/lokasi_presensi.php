        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Lokasi Presensi</span>
                    <span class="text-muted mt-1 fw-bold fs-7">Lokasi Presensi</span>
                </h3>
                    ...
                    <table class="table align-middle gs-0 gy-4" id="kt_table_kategori">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <span class="text-dark fw-bolder d-block fs-6">Kantor Alphatech</span>
                                </td>
                                <td>
                                    <span class="text-dark fw-bolder d-block fs-6">Jl. Hasanuddin No.66, Plipir, Sekardangan, Kec. Sidoarjo, Kabupaten Sidoarjo, Jawa Timur 61215</span>
                                </td>
                                <td class="text-center">
                                    <span class="text-dark fw-bolder d-block fs-6">23</span>
                                </td>
                                <td class="text-center">
                                    <span class="text-dark fw-bolder d-block fs-6">0.1KM</span>
                                </td>
                                <td class="text-center">
                                    <a class="text-dark fw-bolder text-hover-primary d-block fs-6" data-bs-toggle="modal" href="#modalDokumen" role="button"><i class="fa-duotone fa-map-location fs-1"></i></a>
                                </td>
                                <td class="text-end">
                                    <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" href="#modalKaryawan" role="button">
                                        <i class="fa-duotone fa-user-plus fs-5"></i>
                                    </a>
            ...
            <div class="modal-body pb-lg-10 px-lg-10">
                ...
                <div class="fv-row mb-5">
                    ...
                    <div class="position-relative d-flex align-items-center">
                        ...
                        <!--end::Icon-->
                        <input type="text" name="nama" class="form-control form-control-solid ps-12" value="" placeholder="Masukkan nama" aria-placeholder="">
                    </div>
                    <div class="text-danger mx-4 fw-bold" data-field="nama"></div>
                </div>
                <div class="fv-row mb-5">
                    <!--begin::Label-->
                    <label class="fs-6 fw-bold mb-2" for="longitude">
                    ...
                    <div class="position-relative d-flex align-items-center">
                        ...
                        <!--end::Icon-->
                        <input type="number" name="longitude" class="form-control form-control-solid ps-12" value="" placeholder="Masukkan longitude outlet" aria-placeholder="">
                    </div>
                    <div class=" text-danger mx-4 fw-bold" data-field="longitude"></div>
                </div>
                <div class="fv-row mb-5">
                    <!--begin::Label-->
                    <label class="fs-6 fw-bold mb-2" for="latitude">
                    ...
                    <div class="position-relative d-flex align-items-center">
                        ...
                        <!--end::Icon-->
                        <input type="number" name="latitude" class="form-control form-control-solid ps-12" value="" placeholder="Masukkan latitude outlet" aria-placeholder="">
                    </div>
                    <div class=" text-danger mx-4 fw-bold" data-field="longitude"></div>
                </div>
                <div class="fv-row mb-5">
                    <!--begin::Label-->
                    <label class="fs-6 fw-bold mb-2" for="radius">
                    ...
                    <div class="position-relative d-flex align-items-center">
                        <!--begin::Icon-->
                        <span class="svg-icon svg-icon-2 position-absolute mx-4">
                            <i class="fa-duotone fa-circle-dashed fs-5"></i>
                        </span>
                        <!--end::Icon-->
                        <input type="number" name="radius" class="form-control form-control-solid ps-12" value="" placeholder="Masukkan latitude outlet" aria-placeholder="">
                    </div>
                    <div class=" text-danger mx-4 fw-bold" data-field="longitude"></div>
                </div>
                <div class="fv-row mb-5">
