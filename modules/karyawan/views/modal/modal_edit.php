    ...
    <div id="info-umum" class="tabcontent mb-7">
        <div class="fv-row mb-5" id="req_nik">
            ...
            <div class="position-relative d-flex align-items-center">
                ...
                <!--end::Icon-->
                <input type="number" value="<?= $result->nik; ?>" name="nik" class="form-control form-control-solid ps-12" value="" placeholder="Masukkan nik" autocomplete="off">
            </div>
        </div>
        <div class="fv-row mb-5" id="req_email">
            ...
            <div class="position-relative d-flex align-items-center">
                ...
                <!--end::Icon-->
                <input type="text" value="<?= $result->email; ?>" name="email" class="form-control form-control-solid ps-12" value="" placeholder="Masukkan email anda" autocomplete="off">
            </div>
        </div>
        <div class="fv-row mb-5" id="req_nama">
            ...
            <div class="position-relative d-flex align-items-center">
                ...
                <!--end::Icon-->
                <input type="text" value="<?= $result->nama; ?>" name="nama" class="form-control form-control-solid ps-12" value="" placeholder="Masukkan nama" autocomplete="off">
            </div>
        </div>
            ...
            <div class="d-flex">
                <div class="col-6 pe-3">
                    <div class="position-relative d-flex align-items-center">
                        ...
                        <!--end::Icon-->
                        <input type="text" value="<?= $result->gelar_depan; ?>" name="gelar_depan" class="form-control form-control-solid ps-12" value="" placeholder="Masukkan gelar depan" autocomplete="off">
                    </div>
                </div>
                <div class="col-6 ps-3">
                    <div class="position-relative d-flex align-items-center">
                        ...
                        <!--end::Icon-->
                        <input type="text" value="<?= $result->gelar_belakang; ?>" name="gelar_belakang" class="form-control form-control-solid ps-12" value="" placeholder="Masukkan gelar belakang" autocomplete="off">
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex">
                <div class="col-6 pe-3">
                    <div class="position-relative d-flex align-items-center">
                        ...
                        <!--end::Icon-->
                        <input type="text" value="<?= $result->tempat_lahir; ?>" name="tempat_lahir" class="form-control form-control-solid ps-12" value="" placeholder="Masukkan tempat" autocomplete="off">
                    </div>
                </div>
                <div class="col-6 ps-3">
                    <div class="position-relative d-flex align-items-center">
                        ...
                        <!--end::Icon-->
                        <input type="date" value="<?= $result->tanggal_lahir; ?>" name="tanggal_lahir" class="form-control form-control-solid ps-12" placeholder="Masukkan tanggal" />
                    </div>
                </div>
            </div>
            <div class=" text-danger mx-4 fw-bold"></div>
                ...
                <div>
                    <select name="gender" class="form-select form-select-solid select2_load" data-kt-select2="true" data-placeholder="Pilih jenis kelamin">
                        ...
                        <?php if ($profil->gender) : ?>
                            <?php foreach ($profil->gender as $row) : ?>
                                <option value="<?= $row->id_gender; ?>" <?php if ($result->gender == $row->id_gender) {
                                                                            echo 'selected';
                                                                        } ?>><?= $row->gender; ?></option>
                            <?php endforeach; ?>
                        <?php endif; ?>
            ...
            <div class="col-6 ps-3">
                ...
                <div>
                    <select name="status_nikah" class="form-select form-select-solid select2_load" data-kt-select2="true" data-placeholder="Pilih status pernikahan">
                        <option></option>
                        <?php if ($profil->status_menikah) : ?>
                            <?php foreach ($profil->status_menikah as $row) : ?>
                                <option value="<?= $row->id_status; ?>" <?php if ($result->id_nikah == $row->id_status) {
                                                                            echo 'selected';
                                                                        } ?>><?= $row->status_menikah; ?></option>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </select>
                </div>
            ...
            <div class="col-6 pe-3" id="req_agama">
                ...
                <div>
                    <select name="agama" class="form-select form-select-solid select2_load" data-kt-select2="true" data-placeholder="Pilih agama">
                        <option></option>
                        <?php if ($profil->agama) : ?>
                            <?php foreach ($profil->agama as $row) : ?>
                                <option value="<?= $row->id_agama; ?>" <?php if ($result->id_agama == $row->id_agama) {
                                                                            echo 'selected';
                                                                        } ?>><?= $row->agama; ?></option>
                            <?php endforeach; ?>
                        <?php endif; ?>
            ...
            <div class="col-6 ps-3">
                ...
                <div>
                    <select name="golongan_darah" class="form-select form-select-solid select2_load" data-kt-select2="true" data-placeholder="Pilih golongan darah">
                        <option></option>
                        <?php if ($profil->golongan_darah) : ?>
                            <?php foreach ($profil->golongan_darah as $row) : ?>
                                <option value="<?= $row->id_golongan_darah; ?>" <?php if ($result->id_golongan_darah == $row->id_golongan_darah) {
                                                                                    echo 'selected';
        ...
        <div class="fv-row mb-5" id="req_kewarganegaraan">
            ...
            <div>
                <select name="kewarganegaraan" class="form-select form-select-solid select2_load" data-kt-select2="true" data-placeholder="Pilih kewarganegaraan">
                    <option></option>
                    <?php if ($profil->kewarganegaraan) : ?>
                        <?php foreach ($profil->kewarganegaraan as $row) : ?>
                            <option value="<?= $row->id_asal; ?>" <?php if ($result->id_kewarganegaraan == $row->id_asal) {
                                                                        echo 'selected';
                                                                    } ?>><?= $row->asal; ?></option>
                        <?php endforeach; ?>
                    <?php endif; ?>
                    ...
                    <select name="ktp_provinsi" onchange="get_kota(this, '#id_ktp_kota')" id="ktp_provinsi" class=" form-select form-select-solid select2_load" data-kt-select2="true" data-placeholder="Pilih provinsi">
                        ...
                        <?php if ($provinsi) : ?>
                            <?php foreach ($provinsi as $row) : ?>
                                <option value="<?= $row->id_provinsi; ?>" <?php if ($result->id_ktp_provinsi == $row->id_provinsi) {
                                                                                echo 'selected';
                                                                            } ?>><?= $row->nama; ?></option>
                            <?php endforeach; ?>
                        <?php endif; ?>
