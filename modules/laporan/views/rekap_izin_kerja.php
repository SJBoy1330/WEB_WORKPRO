        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-body py-3">
                ...
                <div class="table-responsive">
                    <!--begin::Table-->
                    <table class="table align-middle gs-0 gy-4" id="kt_table_rekap_izin_kerja">
                        <!--begin::Table head-->
                        <thead>
                            <tr class="fw-bolder text-muted bg-light">
                                <th class="ps-4 w-25px rounded-start">
                                    <div class="form-check form-check-sm form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" name="maincheckbox" data-kt-check="true" data-kt-check-target="#kt_table_rekap_izin_kerja .form-check-input" value="1">
                                    </div>
                                </th>
                                <th class="w-50px">No</th>
                                <th class="min-w-125px">Kode</th>
                                <th class="min-w-125px text-center">Tanggal Izin</th>
                                <th class="min-w-150px text-center">Nama</th>
                                <th class="min-w-150px text-center">Kategori</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="text-dark fw-bolder d-block fs-6">Izin Pernikahan</span>
                                </td>
                                <td class="text-center">
                                    <span class="text-dark fw-bolder d-block fs-6">Izin</span>
                                </td>
                                <td class="text-center">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="text-dark fw-bolder d-block fs-6">Sakit Lambung</span>
                                </td>
                                <td class="text-center">
