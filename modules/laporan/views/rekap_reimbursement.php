            ...
            <div id="rekap" class="tabcontent">
                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive">
                        <!--begin::Table-->
                        <table class="table align-middle gs-0 gy-4" id="kt_table_rekap_reimbursement">
                            <!--begin::Table head-->
                            <thead>
                                <tr class="fw-bolder text-muted bg-light">
                                    <th class="ps-4 w-25px rounded-start">
                                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                                            <input class="form-check-input" type="checkbox" name="maincheckbox" data-kt-check="true" data-kt-check-target="#kt_table_rekap_reimbursement .form-check-input" value="1">
                                        </div>
                                    </th>
                                    ...
                                    <th class="min-w-125px text-center rounded-end">Dokumen</th>
                                </tr>
                            </thead>
                            <!--end::Table head-->
                            <!--begin::Table body-->
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="text-dark fw-bolder d-block fs-6">Kategori 1</span>
                                    </td>
                                    <td class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-dark fw-bolder d-block fs-6">332211</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-dark fw-bolder d-block fs-6">27-09-2022</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-dark fw-bolder d-block fs-6">Superadmin</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-dark fw-bolder d-block fs-6">Kategori 2</span>
                                    </td>
                                    <td class="text-center">
            ...
            <div id="rekap-laporan" class="tabcontent">
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <button type="button" class="btn btn-sm btn-light-danger" id="delete_laporan_reimbursement" style="display: none;">
                            <span class="svg-icon svg-icon-2 me-0">
                                <i class="fa-duotone fa-trash" style="font-size: 18px;"></i>
                            </span>
                            Hapus</button>
                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive">
                        <!--begin::Table-->
                        <table class="table align-middle gs-0 gy-4" id="kt_table_rekap_laporan_reimbursement">
                            <!--begin::Table head-->
                            <thead>
                                <tr class="fw-bolder text-muted bg-light">
                                    <th class="ps-4 w-25px rounded-start">
                                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                                            <input class="form-check-input" type="checkbox" name="maincheckbox_laporan_reimbursement" data-kt-check="true" data-kt-check-target="#kt_table_rekap_laporan_reimbursement .form-check-input" value="1">
                                        </div>
                                    </th>
                                    <th class="w-50px">No</th>
                                    <th class="min-w-125px">Kode</th>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="form-check form-check-sm form-check-custom form-check-solid" style="margin-left: 13px;">
                                            <input class="form-check-input deletebox_laporan_reimbursement" type="checkbox" value="1" />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-start flex-column">
