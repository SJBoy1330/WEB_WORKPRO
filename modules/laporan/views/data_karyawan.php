        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-body py-3">
                ...
                <div class="table-responsive">
                    <!--begin::Table-->
                    <table class="table align-middle gs-0 gy-4" id="kt_table_data_karyawan">
                        <!--begin::Table head-->
                        <thead>
                            <tr class="fw-bolder text-muted bg-light">
                                <th class="ps-4 w-25px rounded-start">
                                    <div class="form-check form-check-sm form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" name="maincheckbox" data-kt-check="true" data-kt-check-target="#kt_table_data_karyawan .form-check-input" value="1">
                                    </div>
                                </th>
                                <th class="w-50px">No</th>
                                <th class="min-w-125px">Nama</th>
                                <th class="min-w-125px text-center">Tempat, Tanggal Lahir</th>
                                <th class="min-w-150px text-center">No Telepon</th>
                                <th class="min-w-125px text-center">Jabatan</th>
                                <th class="min-w-100px text-center">Divisi</th>
                                <th class="min-w-125px text-center">Lama Bekerja</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="text-dark fw-bolder d-block fs-6">Sidoarjo 2022-09-08 0 Tahun</span>
                                </td>
                                <td class="text-center">
                                    <span class="text-dark fw-bolder d-block fs-6">0812345678910</span>
                                </td>
                                <td class="text-center">
                                    <span class="text-dark fw-bolder d-block fs-6">Superadmin</span>
                                </td>
                                <td class="text-center">
                                    <span class="text-dark fw-bolder d-block fs-6">Maha Superadmin</span>
                                </td>
                                <td class="text-center">
                                    <span class="text-dark fw-bolder d-block fs-6">0 Tahun 0 Bulan 2022-09-08</span>
                                </td>
                                <td class="text-end">
