        ...
        <div class="card mb-5 mb-xl-8">
            <div class="btn-group w-100 tab mt-5 px-10 tab-presensi">
                ...
                <label class="btn btn-outline-secondary text-muted text-hover-white text-active-white btn-outline btn-active-primary tab tablinks active" data-kt-button="true">
                    <!--begin::Input-->
                    <input class="btn-check" id="defaultOpen" type="radio" onclick="openCity(event, 'rekap')">
                    <!--end::Input-->
                    Rekap
                </label>
                <!--end::Radio-->
                ...
                <label class="btn btn-outline-secondary text-muted text-hover-white text-active-white btn-outline btn-active-primary tab tablinks" data-kt-button="true">
                    <!--begin::Input-->
                    <input class="btn-check" type="radio" onclick="openCity(event, 'rekap-laporan')">
                    <!--end::Input-->
                    Laporan
                </label>
                <!--end::Radio-->
            ...
            <div id="rekap" class="tabcontent">
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-500px" data-kt-menu="true" id="kt_menu_61bc33c4ee0dc">
                                ...
                                <div class="px-7 py-5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <!--begin::Input-->
                                                <div>
                                                    <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Pilih sumber" data-dropdown-parent="#kt_menu_61bc33c4ee0dc" data-allow-clear="true">
                                                        <option></option>
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <!--begin::Input-->
                                        <div>
                                            <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Pilih range user" data-dropdown-parent="#kt_menu_61bc33c4ee0dc" data-allow-clear="true">
                                                <option></option>
                        ...
                        <button type="button" class="btn btn-icon btn-sm btn-light-success btn-active-primary me-2">
                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive">
                        <!--begin::Table-->
                        <table class="table align-middle gs-0 gy-4" id="kt_table_rekap_prospek">
                            <!--begin::Table head-->
                            <thead>
                                <tr class="fw-bolder text-muted bg-light">
                                    <th class="ps-4 w-25px rounded-start">
                                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                                            <input class="form-check-input" type="checkbox" name="maincheckbox" data-kt-check="true" data-kt-check-target="#kt_table_rekap_prospek .form-check-input" value="1">
                                        </div>
                                    </th>
                                    <th class="w-50px">No</th>
                                    <th class="min-w-125px">Tanggal</th>
                                    <th class="min-w-150px text-center">Nama Perusahaan</th>
                                    <th class="min-w-150px text-center">Klien</th>
                                    <th class="min-w-150px text-center">Karyawan</th>
                                    <th class="min-w-125px text-center">Email</th>
                                    <th class="min-w-150px text-center">No Telepon</th>
                                    <th class="min-w-150px text-center">Sumber Prospek</th>
                                    <th class="min-w-125px text-end rounded-end pe-4">Status Prospek</th>
                                </tr>
                            </thead>
                            <!--end::Table head-->
                            <!--begin::Table body-->
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-dark fw-bolder d-block fs-6">26-09-2022</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-dark fw-bolder d-block fs-6">PT. Alphatech Indonesiana</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-dark fw-bolder d-block fs-6">Klien 1</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-dark fw-bolder d-block fs-6">Karyawan 1</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-dark fw-bolder d-block fs-6">email@gmail.com</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-dark fw-bolder d-block fs-6">081234567890</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-dark fw-bolder d-block fs-6">Sumber 1</span>
                                    </td>
                                    <td class="text-end">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="text-dark fw-bolder d-block fs-6">Klien 2</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-dark fw-bolder d-block fs-6">Karyawan 2</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-dark fw-bolder d-block fs-6">email@gmail.com</span>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <span class="text-dark fw-bolder d-block fs-6">Sumber 2</span>
                                    </td>
                                    <td class="text-end">
            ...
            <div id="rekap-laporan" class="tabcontent">
                <div class="card-header border-0 pt-5">
                    <div class="d-flex align-items-center position-relative my-1 pe-2">
                        <span class="svg-icon svg-icon-1 position-absolute ms-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div class="card-toolbar">
                        ...
                        <button type="button" class="btn btn-sm btn-light-danger" id="delete_laporan_prospek" style="display: none;">
                            <span class="svg-icon svg-icon-2 me-0">
                                <i class="fa-duotone fa-trash" style="font-size: 18px;"></i>
                            </span>
                            Hapus</button>
                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive">
                        <!--begin::Table-->
                        <table class="table align-middle gs-0 gy-4" id="kt_table_rekap_laporan_prospek">
                            <!--begin::Table head-->
                            <thead>
                                <tr class="fw-bolder text-muted bg-light">
                                    <th class="ps-4 w-25px rounded-start">
                                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                                            <input class="form-check-input" type="checkbox" name="maincheckbox_laporan_prospek" data-kt-check="true" data-kt-check-target="#kt_table_rekap_laporan_prospek .form-check-input" value="1">
                                        </div>
                                    </th>
                                    <th class="w-50px">No</th>
                                    <th class="min-w-125px">Tanggal</th>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="form-check form-check-sm form-check-custom form-check-solid" style="margin-left: 13px;">
                                            <input class="form-check-input deletebox_laporan_prospek" type="checkbox" value="1" />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-start flex-column">
