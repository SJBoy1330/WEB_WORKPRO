                    ...
                    <table class="table align-middle gs-0 gy-4" id="kt_table_kategori">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="text-dark fw-bolder d-block fs-6">Outlet 1</span>
                                </td>
                                <td class="text-center">
                                    <span class="text-dark fw-bolder d-block fs-6">Bareng indah, Bantengan, Barengkrajan, Kec. Krian, Kabupaten Sidoarjo, Jawa Timur 61262</span>
                                </td>
                                <td class="text-center">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="text-dark fw-bolder d-block fs-6">Outlet 2</span>
                                </td>
                                <td class="text-center">
                                    <span class="text-dark fw-bolder d-block fs-6">Jl. Narotama Barat No.C1 A, Kesatrian, Kec. Blimbing, Kota Malang, Jawa Timur 65121</span>
                                </td>
                                <td class="text-center">
                                    <a href="#" class="btn btn-sm btn-icon btn-light"><i class="fa-duotone fa-file fs-3"></i></a>
                                </td>
