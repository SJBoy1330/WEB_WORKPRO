        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-body py-3">
                ...
                <div class="table-responsive">
                    <!--begin::Table-->
                    <table class="table align-middle gs-0 gy-4" id="kt_table_reimbursement_kategori">
                        <!--begin::Table head-->
                        <thead>
                            <tr class="fw-bolder text-muted bg-light">
                                <th class="ps-4 w-25px rounded-start">
                                    <div class="form-check form-check-sm form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" name="maincheckbox" data-kt-check="true" data-kt-check-target="#kt_table_reimbursement_kategori .form-check-input" value="1">
                                    </div>
                                </th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <span class="text-dark fw-bolder d-block fs-6">Transportasi</span>
                                </td>
                                <td class="text-end">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2>Tambah Kategori Reimbursement</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                ...
                <form class="form" action="#" method="post">
                    <div class="fv-row mb-5">
                        ...
                        <div class="position-relative d-flex align-items-center">
                            ...
                            <!--end::Icon-->
                            <input type="number" class="form-control form-control-solid ps-12" value="" placeholder="Masukkan nama kategori" autocomplete="off">
                        </div>
