        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Pola Kerja</span>
                    <span class="text-muted mt-1 fw-bold fs-7">Pola Kerja</span>
                </h3>
                    ...
                    <table class="table align-middle gs-0 gy-4" id="kt_table_kategori2">
                        ...
                        <thead>
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-125px text-center">Jam Kerja</th>
                            </tr>
                        </thead>
                        <!--end::Table head-->
                        <!--begin::Table body-->
