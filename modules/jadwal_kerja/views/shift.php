        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Shift</span>
                    <span class="text-muted mt-1 fw-bold fs-7">Shift</span>
                </h3>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-lg-15 px-lg-10">
                ...
                <div class="btn-group w-100 tab mb-7">
                    ...
                    <!--begin::Input-->
                    <input class="btn-check tablinks" type="radio" onclick="openCity(event, 'shift-kerja')">
                    <!--end::Input-->
                    Shift Kerja</label>
                    <!--end::Radio-->
                    <!--begin::Radio-->
                    <label class="btn btn-outline-secondary text-muted text-hover-white text-active-white btn-outline btn-active-primary" data-kt-button="true">
                    <!--begin::Input-->
                    <input class="btn-check tablinks" type="radio" onclick="openCity(event, 'libur')">
                    <!--end::Input-->
                    Libur</label>
                    <!--end::Radio-->
                </div>

                <div id="shift-kerja" class="tabcontent mb-7">
                    <div class="card-toolbar">
                        ...
                        <table class="table align-middle gs-0 gy-4">
                            ...
                            <thead>
                                <tr class="fw-bolder text-muted bg-light">
                                    ...
                                    <th class="pe-4 w-100px text-end rounded-end">Divisi</th>
                                </tr>
                            </thead>
                            <!--end::Table head-->
                            <!--begin::Table body-->
                ...
                <div id="libur" class="tabcontent mb-7">
                    <div class="card-toolbar">
                        <div class="d-flex align-items-center position-relative mb-3 pe-2">
                            <span class="svg-icon svg-icon-1 position-absolute ms-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div class="fv-row d-flex">
                    <div class="col-xl-6 pe-3">
                        ...
                        <div class="card shadow-sm bgi-no-repeat card-xl-stretch" style="background-position: right top; background-size: 30% auto; background-image: url(<?= base_url()?>assets/media/svg/shapes/abstract-4.svg">
                            <!--begin::Body-->
                            <div class="card-body">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen032.svg-->
                                <span class="svg-icon svg-icon-primary svg-icon-3x ms-n1">
                                    <i class="fa-duotone fa-briefcase text-primary" style="font-size: 2.8rem;"></i>
                                </span>
                                <!--end::Svg Icon-->
                                <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">Shift - Shift Kerja</div>
                                <div class="fw-bold text-gray-400">10 Karyawan</div>
                            </div>
                            <!--end::Body-->
                        </div>
                    ...
                    <div class="col-xl-6 ps-3">
                        <!--begin::Statistics Widget 5-->
                        <div class="card shadow-sm bgi-no-repeat card-xl-stretch" style="background-position: right top; background-size: 30% auto; background-image: url(<?= base_url()?>assets/media/svg/shapes/abstract-2.svg">
                            <!--begin::Body-->
                            <div class="card-body">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen032.svg-->
                                <span class="svg-icon svg-icon-primary svg-icon-3x ms-n1">
                                    <i class="fa-duotone fa-calendar-week text-primary" style="font-size: 2.8rem;"></i>
                                </span>
                                <!--end::Svg Icon-->
                                <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">Shift - Libur</div>
                                <div class="fw-bold text-gray-400">20 Karyawan</div>
                            </div>
                            <!--end::Body-->
                        </div>
                        <!--end::Statistics Widget 5-->
