    ...
    <?php else: ?>
        <div class="container workpro d-flex justify-content-center align-items-center flex-column px-3">
            ...
            <span class="mt-3 text-center" style="color: #FFB600; font-size: 22px; font-weight: 700;">NOTIFIKASI KOSONG</span>
            <span class="text-center mt-1" style="color: #9F9F9F; font-size: 13px;">Notifikasi tidak tersedia, silahkan kembali ke beranda</span>
        </div>
    <?php endif ?>