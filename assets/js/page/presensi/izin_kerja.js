...
$(function() {
    $("#kt_table_kategori").on("click", function() {
      $("#delete_kategori").toggle($(this).find(".deletebox_kategori:checked").length > 0);
      if($(this).find(".deletebox_kategori:checked").length < ($(this).find(".deletebox_kategori").length)){
          $('input[name="maincheckbox_kategori"]').prop('checked', false);
      }else if($(this).find(".deletebox_kategori:checked").length = ($(this).find(".deletebox_kategori").length)){
        $('input[name="maincheckbox_kategori"]').prop('checked', true);
    }
  })
  $('input[name="maincheckbox_kategori"]').on("click", function() {
      $('.deletebox_kategori').prop('checked', this.checked);
  });
